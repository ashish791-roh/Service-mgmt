...
import { loadTallySettings, saveTallySettingsToAPI, testTallyConnectionAPI, loadTallyStats, uploadTallyDocument } from '../lib/tallySettings';
          ...
          <aside className="space-y-4">
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="grid gap-4">
                <label className="block text-sm font-semibold text-slate-800">Document type</label>
                <select
                  value={documentType}
                ...
                <input type="file" onChange={handleUpload} className="w-full text-sm text-slate-700" />
                {uploadResult && (
