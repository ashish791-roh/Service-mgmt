            ...
            return (
              <Card key={job.id} className="flex flex-col">
                ...
                <div className="p-5 bg-gray-50 border-t border-gray-200 flex gap-3">
                  {!isCompleted ? (
                    <>
                      <Button text="Update Status" variant="primary" onClick={() => { setSelectedJob({ id: job.id, hasPendingParts }); setStatusUpdate({ status: job.status, notes: job.repairNotes ?? '' }); }} className="flex-1" />
