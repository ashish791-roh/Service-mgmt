      ...
      <tr>
        <td style="padding:14px 18px;vertical-align:middle;width:45%;">
          <div style="display:flex;align-items:center;gap:12px;">
            <img src="${resolvedLogo}" height="52" style="object-fit:contain;max-height:52px;display:block;background:transparent;background-color:transparent;background-image:none;border:none;" alt="${BUSINESS_INFO.shopName}" />
            <div>
