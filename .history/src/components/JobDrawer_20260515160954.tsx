...
import { X, CheckCircle, Clock, User, ShieldAlert, Star, Activity, AlertCircle, Image as ImageIcon, Upload, ShieldCheck, Edit2, ArrowRightLeft, Save, ChevronDown, ChevronUp } from 'lucide-react';
