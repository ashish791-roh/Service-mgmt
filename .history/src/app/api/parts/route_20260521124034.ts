...
export async function POST(request: Request) {
    ...
    try {
        ...
        writeAuditLog({
            ...
            action: 'create', entity: 'partRequest', entityId: finalRequest.id,
            meta: { jobId: finalRequest.jobId, partName: finalRequest.partName, quantity: finalRequest.quantity, status: finalRequest.status },
        }).catch(() => {});
