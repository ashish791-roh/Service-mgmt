...
// Default to <project-root>/.webhook_store.json (works on Windows & Linux).
// Override with WEBHOOK_STORE_PATH if you need a different location —
...
function saveWebhooks(hooks: WebhookConfig[]): void {
  // Auto-create the parent directory so custom paths work without manual setup,
  // on both Windows (C:\...) and Linux/macOS (/var/data/...).
