...
export type PartRequestStatus = 'Pending' | 'Approved' | 'Rejected' | 'AwaitingStock';
...
export interface Job {
  ...
  actualCost?: number;
  /** Advance / deposit collected at job intake. Deducted from balance due. */
...
export type InventoryAvailability = 'available' | 'low_stock' | 'out_of_stock' | 'not_found';
...
export interface PartRequest {
  ...
  /** Available quantity in inventory at submission time */
